...
consonants= [x for x in sentence if x not in vowels]
...
random_lists = [random.sample(range(0,100),10) for x in range(4)]
...
flatten_list = [y for y in x for x in list_of_lists]
